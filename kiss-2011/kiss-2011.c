/* Source:
 * https://zuttobenkyou.wordpress.com/2012/05/01/\
 * kiss-2011-version-in-c-and-haskell/
 */
...
int main(void) {
    randk_seed();
    randk_warmup(10000u);
    for(uint32_t idx=0u;idx < 100;idx++) {
        printf("%lu\n", randk());
    }
    return 0;
}
